...
| 发布分级 | Gold 1,434 / Silver 5,798 / Bronze 10,387 / Rejected 10,802（全部留档） |
| 自动修复 | 14,754 条（解释级别校正 1.6 万次、证据裁剪、假支持剔除 93 处） |
| 主题规则 | 1,438 章节 + 57 单书 + 4 类目 |
| MergedHermesRule | 329 条（含证据链 / variant_set / conflict_set） |
| Hermes Skills | 329 个（`data/skills/`，7 gold） |
