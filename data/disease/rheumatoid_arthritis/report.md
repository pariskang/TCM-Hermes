...
> 生成于 2026-06-12T12:38:57Z；框架：TCM-Disease-Hermes（多智能体检索—审核—抽取—分析）。
> 古今映射为表型对应/候选，非现代诊断；每条结论可回源至原文证据片段。

## 摘要

以现代疾病“类风湿关节炎”为起点，经古病名扩展、表型组合检索、特殊表型补充、形态学精筛与排除性鉴别获取候选条文；再经证据回源、三视角相关性评审与共识裁决完成纳入判断；最终以五层本体映射、关系抽取、复杂网络与时序分析将非结构化古籍文本转化为可计算、可追溯的证据链。共获候选条文 600 条，纳入（Gold+Silver）5 条。
...
核心古病名（14个）：歷節、痹、風痹、寒痹、濕痹、着痹、行痹、痛痹、尪痹、鶴膝風、白虎歷節、周痹、頑痹、歷節風。
排除性鉴别疾病：痿、痿證、脚氣、丹毒、流注、骨痿、中風偏枯、痛風石。
...
- 候选条文：600 条；
- 分级：Gold 0 / Silver 5 / Bronze 86 / Rejected 509；
- 命中分型分布：{'joint_pain': 87, 'swelling': 1, 'deformity': 1, 'systemic': 2}；
- 核心药物（按中心性）：桂枝、甘草、芍藥、附子、麻黃、白朮、知母、生薑；
- 涉及朝代：漢、宋、明、清、未知。

### 2.1 药物网络
核心药物（按 PageRank/度中心性）：桂枝、甘草、芍藥、附子、麻黃。

### 2.2 时序演变
- 漢：主要病机 —；主要治法 —
- 宋：主要病机 —；主要治法 —
- 明：主要病机 寒濕；主要治法 —
- 清：主要病机 寒濕、風寒、風濕；主要治法 —
- 未知：主要病机 風濕、風寒、風寒濕；主要治法 溫經散寒、溫陽、養血

## 3 讨论

1. 主要发现：“类风湿关节炎”的古籍证治呈现以桂枝、甘草、芍藥、附子、麻黃、白朮、知母、生薑为核心的药物结构，病机以风、血、湿相关为主线。
