...
以现代疾病“骨质疏松”为起点，经古病名扩展、表型组合检索、特殊表型补充、形态学精筛与排除性鉴别获取候选条文；再经证据回源、三视角相关性评审与共识裁决完成纳入判断；最终以五层本体映射、关系抽取、复杂网络与时序分析将非结构化古籍文本转化为可计算、可追溯的证据链。共获候选条文 6 条，纳入（Gold+Silver）2 条。
...
核心古病名（10个）：骨痿、骨枯、骨極、骨痹、骨蝕、髓枯、虛劳腰痛、腰痛、痿、骨重。
排除性鉴别疾病：附骨疽、骨疽、骨癰、骨瘤、骨蒸、歷節、鶴膝風、脚氣、龜背。
...
- 候选条文：6 条；
- 分级：Gold 0 / Silver 2 / Bronze 1 / Rejected 3；
- 命中分型分布：{'bone_loss': 3}；
- 核心药物（按中心性）：（样本不足）；
- 涉及朝代：戰國、元、明。
...
- 戰國：主要病机 髓減；主要治法 —
- 元：主要病机 —；主要治法 補腎
- 明：主要病机 腎虛；主要治法 補腎、填精、壯骨

## 3 讨论

1. 主要发现：“骨质疏松”的古籍证治呈现以（样本不足）为核心的药物结构，病机以风、血、湿相关为主线。
