...
> 生成于 2026-06-12T12:38:45Z；框架：TCM-Disease-Hermes（多智能体检索—审核—抽取—分析）。
> 古今映射为表型对应/候选，非现代诊断；每条结论可回源至原文证据片段。

## 摘要

以现代疾病“银屑病”为起点，经古病名扩展、表型组合检索、特殊表型补充、形态学精筛与排除性鉴别获取候选条文；再经证据回源、三视角相关性评审与共识裁决完成纳入判断；最终以五层本体映射、关系抽取、复杂网络与时序分析将非结构化古籍文本转化为可计算、可追溯的证据链。共获候选条文 6556 条，纳入（Gold+Silver）3 条。
...
- 候选条文：6556 条；
- 分级：Gold 0 / Silver 3 / Bronze 84 / Rejected 6469；
- 命中分型分布：{'scalp': 11, 'nail': 30, 'arthropathic': 8, 'vulgaris': 21, 'erythrodermic': 14, 'pustular': 3}；
- 核心药物（按中心性）：甘草、當歸、附子、雄黃、白朮、黃連、水銀、川芎；
- 涉及朝代：宋、元、明、清、未知。

### 2.1 药物网络
核心药物（按 PageRank/度中心性）：甘草、當歸、附子、雄黃、白朮。

### 2.2 时序演变
- 宋：主要病机 風毒；主要治法 —
- 元：主要病机 —；主要治法 殺蟲
- 明：主要病机 濕熱、風毒、風濕；主要治法 殺蟲、針刺、艾灸
- 清：主要病机 濕熱、風熱、腠理；主要治法 針刺、殺蟲、艾灸
- 未知：主要病机 風濕、寒濕；主要治法 —

## 3 讨论

1. 主要发现：“银屑病”的古籍证治呈现以甘草、當歸、附子、雄黃、白朮、黃連、水銀、川芎为核心的药物结构，病机以风、血、湿相关为主线。
