...
- **Skill**: `hermes.formula.formula_f5334d0a`
- **Merged rule**: `MHR_FORMULA_FORMULA_F5334D0A`
- **Release level**: silver
- **Consensus score**: 0.92
- **Supporting initial rules**: 2

## 归纳主张
豬苓散可歸納為嘔吐、狐惑等方證的核心方（支持條文 2 條，跨 2 部書）。

## 原文证据（节选）
> 蝕上為惑。蝕下為狐。狐惑病者。豬苓散主之。
> ——《金匱玉函要略輯義》·論一首、證三條、方十二首（SU_JGYL_JIYI_000428，silver）
