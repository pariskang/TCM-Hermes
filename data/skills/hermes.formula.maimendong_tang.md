...
## 归纳主张
麥門冬湯可歸納為勞復、傷寒、上氣、發熱、咳、脈數等方證的核心方（支持條文 5 條，跨 5 部書）。
...
## 版本差异 variant_set
- {"kind": "condition_variant", "book_id": "BOOK_JGYL_JIYI", "book_title": "金匱玉函要略輯義", "distinct_conditions": ["傷寒"], "rule_ids": ["IR_JGYL_JIYI_000116"]}
